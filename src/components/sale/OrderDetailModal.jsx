      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span
                  className={`px-2 py-1 rounded-full text-xs ${getTypeBadge(order.type).class}`}
                >
                  {getTypeBadge(order.type).label}
                </span>
                <span
                  className={`px-2 py-1 rounded-full text-xs ${getStatusBadge(order.status).class}`}
                >
        ...
        <div className="p-6 border-t flex gap-3">
          ...
          <button
            ...
            className="flex-1 border border-indigo-200 text-indigo-600 py-3 rounded-xl font-medium hover:bg-indigo-50 flex items-center justify-center gap-2"
          >
            <MessageSquare className="w-5 h-5" /> SMS
          </button>
          <button
            onClick={() => onSendEmail(order.id)}
            className="flex-1 border border-blue-200 text-[#0f5dd9] py-3 rounded-xl font-medium hover:bg-blue-50 flex items-center justify-center gap-2"
          >
