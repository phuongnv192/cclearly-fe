...
const ResetPasswordPage = () => {
  ...
  if (success) {
    return (
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold mb-2 text-[#222]">Đặt lại mật khẩu thành công!</h2>
  ...
  return (
    <div>
      ...
      <p className="text-[#4f5562] mb-8">Nhập mật khẩu mới cho tài khoản của bạn</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="block text-sm font-medium text-[#222] mb-2">Mật khẩu mới</label>
