...
import { useAdminDashboard, useAdminUsers, usePromotions } from '@/hooks/useAdmin';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-[#222]">Manager Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow">
          ...
          <p className="text-sm text-[#4f5562]">Total Customers</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow">
          ...
          <p className="text-sm text-[#4f5562]">Total Revenue</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow">
          ...
          <p className="text-sm text-[#4f5562]">Total Orders</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow">
          ...
          <p className="text-3xl font-bold">{stats.ordersByStatus?.cancelled || 0}</p>

          <p className="text-sm text-[#4f5562]">Total Returns</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow">
          <div className="flex justify-between mb-4">
            <h3 className="font-semibold">Nhân viên hoạt động</h3>

            <Link to="/admin/staff" className="text-[#0f5dd9] text-sm">
              Xem tất cả
            </Link>
          </div>
            ...
            {activeStaff.slice(0, 4).map((member) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#4f5562]">{member.role}</p>
                </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow">
          <div className="flex justify-between mb-4">
            <h3 className="font-semibold">Khuyến mãi đang hoạt động</h3>

            <Link to="/admin/promotions" className="text-[#0f5dd9] text-sm">
              Xem tất cả
            </Link>
          </div>
            ...
            {activeCoupons.slice(0, 3).map((coupon) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#4f5562]">{coupon.description}</p>
                </div>
