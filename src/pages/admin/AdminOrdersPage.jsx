              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-[#ececec]">
                  {orders.map((order) => (
                    ...
                    >
                      <td className="px-4 py-2.5 font-bold text-sm text-[#222]">
                        {order.id}
                      </td>
                      <td className="px-4 py-2.5 text-xs text-[#4f5562]">
                        <span className="bg-gray-100 px-2 py-0.5 rounded-md text-[10px] font-bold uppercase flex items-center gap-1 w-fit">
                          {order.type === 'prescription' && (
                            <Scan className="w-3 h-3 text-[#0f5dd9]" />
                          )}
                          {getTypeLabel(order.type)}
                        </span>
                      </td>
                      <td className="px-4 py-2.5 text-sm text-[#222] font-medium">
                      ...
                      <td className="px-4 py-2.5 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <select
                            value={order.status}
                            onChange={(e) =>
                              handleStatusChangeClick(order.id, e.target.value)
                            }
